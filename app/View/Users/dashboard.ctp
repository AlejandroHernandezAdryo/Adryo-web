  ...
  <div class="outer">
    <div class="inner lter bg-container">
      ...
      <!-- Mensajes gerenciales y proximos eventos --> 
       ...
       <!-- METAS VS METAS CUENTA -->
      <div class="row mt-1">
        <div class="col-sm-12">
          <?= $this->Element('Desarrollos/ventas_vs_metas_dash_by_ajax') ?>
        </div>
      </div>
       <!-- METAS VS METAS CUENTA MONTO -->
      <div class="row mt-1">
        <div class="col-sm-12">
          <?= $this->Element('Desarrollos/ventas_vs_metas_dash_dinero_by_ajax') ?>
        </div>
      </div>
      
       <!-- CLIENTES POR FORMA DE CONTACTO DEL MES CORRIENDO  -->
      <div class="row mt-1">
        <div class="col-sm-12">
          <?= $this->Element('Clientes/clientes_mes_by_ajax') ?>
        </div>
      </div>
       <!-- CLIENTES LINEA DE CONTACTO, INVERSION Y VENTAS -->
      
      <div class="row mt-1">
        <div class="col-sm-12">
          <?= $this->Element('Clientes/clientes_linea_ventas_inversion_by_ajax') ?>
        </div>
      </div>
       <!-- CLIENTES LINEA DE CONTACTO, INVERSION Y VISITAS -->
      
      <div class="row mt-1">
        <div class="col-sm-12">
          <?= $this->Element('Clientes/clientes_linea_contacto_visitas_inversion_by_ajax') ?>
        </div>
      </div>
...
<script>
  $(document).ready(function () {
    ...
    graficaClientesEstatus(dataRange, cuenta_id, 0, 0);
    graficaClientesActivos( dataRange, cuenta_id, 0, 0 );
    graficaClientesEtapa(  dataRange, cuenta_id, 0, 0  );
    graficaVentasMetasDash(  dataRange, cuenta_id, 0, 0  );
    graficaVentasMetasDashDinero(  dataRange, cuenta_id, 0, 0);
    graficaClientesMes(  mescorriendo, cuenta_id, 0, 0);
    graficaClientesLineaDash(  dataRange, cuenta_id, 0, 0);
    graficaClientesVisitasDash(  dataRange, cuenta_id, 0, 0);
