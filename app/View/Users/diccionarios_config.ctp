                                                ...
                                                <div class="card-block">
                                                    <div class="col-md-12 m-t-10 accordian_alignment">
                                                        <div id="accordion" role="tablist" aria-multiselectable="true">
                                                                    ...
                                                                    <div class="card-block m-t-20">
                                                                            ...
                                                                            <div class="card-block">
                                                                                <div class="card-block m-t-20">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <?= $this->Form->input('etapa_embudo',array('type'=>'select','options'=>$dic_embudo_ventas, 'class'=>'form-control','div'=>'col-sm-6','label'=>'Etapa en la que comienza esta línea de contacto'))?>
                                                                                            <span class="input-group-btn">
                                                                                        <button class="btn btn-primary" type="submit">
                                                                                            <span class="glyphicon glyphicon-search" aria-hidden="true">
                                                                            ...
                                                                            <table class="table table-sm ">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?= $dic_embudo_ventas[$linea['DicLineaContacto']['etapa_embudo']]?></td>
                                                                                    <td>
                                                                                        <span>
                                                            ...
                                                            <!-- Documentos para la operacion de inmuebles de desarrollo. -->
                                                            <div class="card mt-2">
                                                                <div class="card-header bg-blue-is" role="tab" id="title-one">
                                                                    <a class="collapsed accordion-section-title" style="color: white;" data-toggle="collapse" data-parent="#accordion" href="#documentos_operacion_inmueble" aria-expanded="false">
                                                                        Documentos requeridos para las operaciones de las propiedades del desarrollo
                                                                         <i class="fa fa-plus float-xs-right m-t-5"></i>
                                                                         <span class="tag tag-pill tag-warning float-xs-right calendar_tag menu_hide"><?= sizeof($doc_operaciones)?></span>
                                                                    </a>
                                                                </div>
                                                                <?php if (isset($tab) && $tab == 1){?>
                                                                    <div id="documentos_operacion_inmueble" class="card-collapse">
                                                                <?php }else{?>
                                                                    <div id="documentos_operacion_inmueble" class="card-collapse collapse">
                                                                <?php } ?>
                                                                    ...
                                                                    <div class="card-block m-t-20">
                                                                        <?php echo $this->Form->create('Diccionario',array('url'=>array('action'=>'add_diccionario','controller'=>'Diccionarios')))?>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                ?>
                                                                                <?=
                                                                                    $this->Form->input('sub_directorio',
                                                                                        array(
                                                                                            'class'    => 'form-control',
                                                                                            'div'      => 'col-sm-12 col-lg-6',
                                                                                            'label'    => 'Tipo de operación relacionada*',
                                                                                            'required' => true,
                                                                                            'empty'    => 'Seleccione una opción',
                                                                                            'options'  => $tipo_docs_operaciones
                                                                                        )
                                                                                    );
                                                                                ?>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-sm-12 col-lg-6 mt-2">
                                                                                    <?=
                                                                                        $this->Form->submit('Agregar documento de apoyo',
                                                                                            array(
                                                                                                'class' => 'btn btn-primary'
                                                                                            )
                                                                                        );
                                                                        ...
                                                                        <div class="card-block">
                                                                            <table class="table table-sm ">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th>Tipo de operación relacionada</th>
                                                                                    <th style="width:20%">Editar</th>
                                                                                    <th style="width:20%">Eliminar</th>
                                                                                </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                <?php foreach ($doc_operaciones as $doc_operacion):?>

                                                                                <tr>
                                                                                    <td><?= $doc_operacion['Diccionario']['descripcion'] ?></td>
                                                                                    <td><?= $tipo_docs_operaciones[$doc_operacion['Diccionario']['sub_directorio']] ?></td>
                                                                                    <td>
                                                                                        <span>
                                                                                            <i class="fa fa-pencil pointer" onclick="editDiccionario(11, <?= $doc_operacion['Diccionario']['id'] ?>, '<?= $doc_operacion['Diccionario']['descripcion'] ?>' )">
                                                                                            </i>
                                                                                        </span>
                                                                                    </td>
                                                                                    <td>
                                                                                        <span>
                                                                                            <?= $this->Form->postLink('<i class="fa fa-trash-o fa-lg"></i>', array('controller'=>'Diccionarios','action' => 'delete', $doc_operacion['Diccionario']['id']), array('escape'=>false), __('Desea eliminar esta opción ?', $doc_operacion['Diccionario']['id'])); ?>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                                <?php endforeach;?>
                                                            ...
                                                            <div class="card mt-2">
                                                                <div class="card-header bg-blue-is" role="tab" id="title-one">
                                                                    <a class="collapsed accordion-section-title" style="color: white;" data-toggle="collapse" data-parent="#accordion" href="#dic_cancelaciones_operraciones" aria-expanded="false">
                                                                        Diccionario para cancelar las operaciones de las propiedades del desarrollo
                                                                         <i class="fa fa-plus float-xs-right m-t-5"></i>
                                                                         <span class="tag tag-pill tag-warning float-xs-right calendar_tag menu_hide"><?= sizeof($dic_cancelacion_operaciones)?></span>
                                                                    </a>
                                                                </div>
                                                                <?php if (isset($tab) && $tab == 1){?>
                                                                    <div id="dic_cancelaciones_operraciones" class="card-collapse">
                                                                <?php }else{?>
                                                                    <div id="dic_cancelaciones_operraciones" class="card-collapse collapse">
                                                                <?php } ?>
                                                                    ...
                                                                    <div class="card-block m-t-20">
                                                                        <?php echo $this->Form->create('Diccionario',array('url'=>array('action'=>'add_diccionario','controller'=>'Diccionarios')))?>
                                                                                ...
                                                                                <?=
                                                                                    $this->Form->input('sub_directorio',
                                                                                        array(
                                                                                            ...
                                                                                            'required' => true,
                                                                                            'empty'    => 'Seleccione una opción',
                                                                                            'options'  => $dic_cancelacion_operraciones_opciones
                                                                                        )
                                                                                    );
                                                                                ?>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-sm-12 col-lg-6 mt-2">
                                                                                    <?=
                                                                                        $this->Form->submit('Agregar cancelacion de apoyo',
                                                                                            array(
                                                                                                'class' => 'btn btn-primary'
                                                                                            )
                                                                                        );
                                                                        ...
                                                                        <div class="card-block">
                                                                            <table class="table table-sm ">
                                                                                ...
                                                                                <tbody>
                                                                                <?php foreach ($dic_cancelacion_operaciones as $opt_cancelacion):?>

                                                                                <tr>
                                                                                    <td><?= $opt_cancelacion['Diccionario']['descripcion'] ?></td>
                                                                                    <td><?= $dic_cancelacion_operraciones_opciones[$opt_cancelacion['Diccionario']['sub_directorio']] ?></td>
                                                                                    <td>
                                                                                        <span>
                                                                                            <i class="fa fa-pencil pointer" onclick="editDiccionario(12, <?= $opt_cancelacion['Diccionario']['id'] ?>, '<?= $opt_cancelacion['Diccionario']['descripcion'] ?>' )">
                                                                                            </i>
                                                                                        </span>
                                                                                    </td>
...
<script>
    ...
    function editDiccionario( idFormulario, idDiccionario, valorActual, paramAdd1 ) {
        ...
        switch( idFormulario ){
            ...
            case 12:
                document.getElementById("header-formulario").innerHTML = 'Edición DICCIONARIO PARA CANCELAR LAS OPERACIONES DE LAS PROPIEDADES DEL DESARROLLO';
                document.getElementById("form-edit").innerHTML = "<form id='formEditDiccionarios' method='post' action='<?php echo Router::url(array("controller" => "Diccionarios", "action" => "edit_diccionario")); ?>'> <div class='row'> <div class='col-sm-12'> <input class='form-control' name='data[Diccionario][descripcion]' value='"+valorActual+"'> <input type='hidden' name='data[Diccionario][id]' value='"+idDiccionario+"'> </div> <div class='col-sm-12 mt-1'> </div> <div class='modal-footer'> <button class='btn btn-success btn-sm pull-left mt-1' type='button' onclick='formSubmit()'>Guardar cambios</button> <button class='btn btn-error btn-sm float-xs-right mt-1' data-dismiss='modal'>Cancelar</button> </div> </div> </form>";
            break;
