                            ...
                            <div class="bd-menu-39-popup ">
                                <ul class=" bd-menu-39  bd-no-margins">
                                    <li class=" bd-menuitem-38 bd-sub-item bd-sub-item">
                                        <?= $this->Html->link('Cartera de Clientes',array('controller'=>'pages','action'=>'cartera-clientes'))?>
                                    </li>
                                    <li class=" bd-menuitem-38 bd-sub-item bd-sub-item">
                                        <?= $this->Html->link('Corretaje',array('controller'=>'pages','action'=>'corretaje'))?>
                                    </li>
                                    <li class=" bd-menuitem-38 bd-sub-item bd-sub-item">
                                        <?= $this->Html->link('Desarrollos',array('controller'=>'pages','action'=>'desarrollos'))?>
                                    </li>
                                    <li class=" bd-menuitem-38 bd-sub-item bd-sub-item">
                                        <?= $this->Html->link('Desarrolladores',array('controller'=>'pages','action'=>'desarrolladores'))?>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class=" bd-menuitem-36 bd-toplevel-item">
                            <?= $this->Html->link('Adryo',array('controller'=>'pages','action'=>'inmosystem'))?>
                        </li>
                        <li class=" bd-menuitem-36 bd-toplevel-item">
                            <?= $this->Html->link('Solicita una Prueba',array('controller'=>'pages','action'=>'solicita_prueba'))?>
                        </li>
<!--                        <li class=" bd-menuitem-36 bd-toplevel-item">
                            <?= $this->Html->link('Planes',array('controller'=>'pages','action'=>'planes'))?>
                        </li>-->
                        <li class=" bd-menuitem-36 bd-toplevel-item">
                            <?= $this->Html->link('Contacto',array('controller'=>'pages','action'=>'contacto'))?>
                        </li>
                        <li class=" bd-menuitem-36 bd-toplevel-item">
...
<!--        <section class=" bd-section-5 bd-page-width bd-tagstyles " id="section4" data-section-title="Two Thirds">
 ...
 col-sm-6">
    ...
    La mejor plataforma en línea para le gestiòn de negocios inmobiliarios, corretaje y contstrucción.&nbsp;<br><br><br>2018 Todos los derechos Reservados<br>Inmosystec S.A. de C.V.
</p></div></div>
</div>
 ...
 col-sm-6">
    ...
    otras
		...
		<p class=" bd-textblock-51 bd-no-margins bd-content-element">
                    <?= $this->Html->link('¿Qué es Adryo?',array('controller'=>'pages','action'=>'inmosystem'))?>
...
<!--		<div class="bd-separator-8  bd-separator-center bd-separator-content-center clearfix" >
 ...
 col-sm-6">
    ...
    contacto@inmosystem.com.mx<br>inmosystem.com.mx
</p>
    </div>
</div></div></div>
</div>
