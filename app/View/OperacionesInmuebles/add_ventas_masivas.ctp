                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <?php
                                ...
                                //     $newData[$i] = explode(',', $row);
                                //     foreach( $newData as $venta ){
                                //         echo $venta[0];
                                //         echo $venta[1];
                                //     }
                                // }
                            ?>
                                <?= $this->Form->create( 'Operaciones' ) ?>
                                            ...
                                            <?php $i = 0; ?>
                                                <?php foreach( $response['data'] as $row ): ?>
                                                    ...
                                                    <?php foreach( $newData as $venta ): ?>
                                                        ...
                                                        <td>
                                                            <?= $this->Form->input('tipo_operacion', array(
                                                                'label' => false,
                                                                'class' => 'form-control',
                                                                'div'   => 'col-sm-12',
                                                                'value' => $venta[1],
                                                                'name' => 'data[Operaciones]['.$i.'][tipo_operacion]'
                                                            )) ?>
                                                        </td>
                                                        <td>
                                                            <?= $this->Form->input('precio_unidad', array(
                                                                'label' => false,
                                                                'class' => 'form-control',
                                                                'div'   => 'col-sm-12',
                                                                'value' => $venta[2],
                                                                'name' => 'data[Operaciones]['.$i.'][precio_unidad]'
                                                            )) ?>
                                                        </td>
                                                        <td>
                                                            <?= $this->Form->input('precio_cierre', array(
                                                                'label' => false,
                                                                'class' => 'form-control',
                                                                'div'   => 'col-sm-12',
                                                                'value' => $venta[3],
                                                                'name' => 'data[Operaciones]['.$i.'][precio_cierre]'
                                                            )) ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?= $this->Form->input('cliente_id', array(
                                                                ...
                                                                'options' => $clientes,
                                                                'value' => $venta[5],
                                                                'name' => 'data[Operaciones]['.$i.'][cliente_id]'
                                                            )) ?>
                                                        </td>
                                                        <td>
                                                            <?= $this->Form->input('user_id', array(
                                                                ...
                                                                'options' => $agentes,
                                                                'value' => $venta[6],
                                                                'name' => 'data[Operaciones]['.$i.'][user_id]'
                                                            )) ?>
                                                        </td>
                                                        <td>
                                                            <?= $this->Form->input('vigencia_operacion', array(
                                                                'label'=>false,
                                                                'class' => 'form-control',
                                                                'div' => 'col-sm-12',
                                                                'value' => $venta[7],
                                                                'name' => 'data[Operaciones]['.$i.'][vigencia_operacion]'
                                                            )) ?>
                                                        </td>
                                                        <td>
                                                            <?= $this->Form->input('inmueble_id', array(
                                                                ...
                                                                'value' => $venta[8],
                                                                'type' => 'text',
                                                                'name' => 'data[Operaciones]['.$i.'][inmueble_id]'
                                                            )) ?>
                                                        </td>
                                                    <?php $i++ ; ?>
                                                    <?php endforeach;?>
...
<script>
    ...
    $(document).on("submit", "#OperacionesAddVentasMasivasForm", function (event) {
        $("#overlay").fadeIn();
        event.preventDefault();
        $.ajax({
            url        : '<?php echo Router::url(array('action'=>'f_add_venta','controller'=>'OperacionesInmuebles')); ?>',
            type       : "POST",
            dataType   : "json",
