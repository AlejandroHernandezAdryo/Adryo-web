...
<div id="content" class="bg-container">
    ...
    <div class="outer">
        <div class="inner bg-light lter bg-container">
            <div class="card">
                        <div class="card-header bg-white">
                            <i class="fa fa-plus"></i> Agregar Linea de Contacto
                        </div>
                        <div class="card-block">
                            <div class="card-block m-t-20">
                                            <?php echo $this->Form->create('DicLineaContacto')?>
                                            ...
                                            <input type="search" class="form-control" name="data[DicLineaContacto][linea_contacto]" id="DicTipoClienteTipoCliente">
                                                ...
                                                </span> Agregar Linea de Contacto</button>
                                                </span>
                                                </div>
        ...
        <div class="inner bg-light lter bg-container">
            <div class="card">
                        <div class="card-header bg-white">
                            <i class="fa fa-book"> </i> Líneas de contacto
                        </div>
                        <div class="card-block">
                            <div class="m-t-35">
