                                            ...
                                            <div class="row">
                                                ...
                                                <script>
                                                   ...
                                                   <div class="form-group col-md-4" id="">
														<?php
															$status = array('0'=>'Baja','1'=>'Bloqueado','2'=>'Libre/Venta','3'=>'Apartados/Reservados','4'=>'Vendidos/Contratos','5'=>'Escriturados');

															echo $this->Form->input('status', array('div' => 'form-group','class'=>'form-control','type'=>'select','options'=>$status,'empty'=>'Selecciona el estatus de la propiedad','label'=>'Estatus','id'=>'Estatus'));
														?>
													</div>
