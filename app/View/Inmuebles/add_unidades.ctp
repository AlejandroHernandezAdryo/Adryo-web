                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                    ...
                                    <div id="rootwizard">
                                        ...
                                        <div class="card-block m-t-35">
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                <?php
                                                    echo $this->Form->input('referencia', array('class'=>'form-control','div' => 'form-group col-md-6', 'value'=>$desarrollo['Desarrollo']['referencia']));
                                                    echo $this->Form->input('titulo', array('class'=>'form-control','div' => 'form-group col-md-6', 'value'=>$desarrollo['Desarrollo']['nombre'], 'label' => 'Título'));
                                                    echo $this->Form->input('dic_tipo_propiedad_id', array('label'=>'Tipo de Inmueble','div' => 'form-group col-md-6','class'=>'form-control','type'=>'select','options'=>$tipo_propiedad,'empty'=>'Selecciona un tipo de propiedad', 'selected'=>$desarrollo['Desarrollo']['dic_tipo_propiedad_id']));
                                                ?>
                                                ...
                                                <script>
                                                    ...
                                                    <div class="form-group col-md-6" id="precio1">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="data[Inmueble][precio]" class="form-control" id="currency" aria-label="Amount (rounded to the nearest dollar)">
                                                    ...
                                                    <div class="form-group col-md-6" style="display:none" id="precio2">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-addon">$</span>
                                                            <input type="text" name="data[Inmueble][precio_2]" class="form-control" id="currency" aria-label="Amount (rounded to the nearest dollar)">
                                                            <span class="input-group-addon">.00</span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="card-block" style="margin-left: 15px; margin-right: 15px">
                                            ...
                                            <div class="row">
                                                <?php echo $this->Form->input('construccion', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Superficie habitable (m2)','onchange'=>'javascript:suma()', 'value'=>0))?>
                                                <?php echo $this->Form->input('construccion_no_habitable', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Superficie No Habitable (m2)','onchange'=>'javascript:suma()', 'value'=>0))?>
                                                <script>
                                                    function suma(){
                                                        var total = 0;
                                                        var posiciones = 2;
                                                        
                                                        total = parseFloat(document.getElementById('InmuebleConstruccion').value) + parseFloat(document.getElementById('InmuebleConstruccionNoHabitable').value);
                                                ...
                                                <?php echo $this->Form->input('total_espacio', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Superficie Total (m2)','disabled'=>true,'id'=>'total'))?>
                                                ...
                                                <?php echo $this->Form->input('niveles_totales', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Niveles de la Propiedad (Unidad Actual)'))?>
                                    ...
                                    <div class="card-block" style="margin-left: 15px; margin-right: 15px">
                                        <h2><font color="black">¿Cuántas unidades adicionales quieres crear?</font></h2>
                                        <p>Al llenar la siguiente casilla, el sistema creará automáticamente el número de unidades tipo. Esto funciona para cargar diferentes modelos al mismo tiempo</p>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label for="CantidadReplica">Cantidad a Replicar (Contando la actual)</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <?php echo $this->Form->input('cantidad', array('div' => 'form-group col-md-2','class'=>'form-control','label'=>False, 'type'=>'number'))?>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-block m-t-35" style="margin-left: 15px; margin-right: 15px">        
                                            <div class="form-actions form-group row m-t-20">
                                                ...
                                                <div class="col-xl-6">
                                                    <input type="submit" value="Guardar Información y Cargar otra Unidad" class="btn btn-success" style="width:100%" onclick="javascript:document.getElementById('InmuebleReturn').value=2">
                                                </div>
                                            </div>
                                            <?= $this->Form->end()?>
                                        </div>
