                                    ...
                                    <div id="rootwizard">
                                        <div class="card-block m-t-35">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12">
                                                    <?php echo $this->Form->input ('descripcion'.$i, array('placeholder'=>'Descripción','value'=>$imagen['FotoInmueble']['descripcion'],'label'=>false,'style'=>'width:100%'))?>
                                                </div>
                                                <div class="col-xs-12">
                                                    <?php echo $this->Form->input ('orden'.$i, array('placeholder'=>'Orden','value'=>$imagen['FotoInmueble']['orden'],'label'=>false,'style'=>'width:100%'))?>
                                                    <?php echo $this->Form->input('id'.$i,array('type'=>'hidden','value'=>$imagen['FotoInmueble']['id']));?>
                                                </div>
                                                <div class="col-xs-12">
                                                <style> .btn-danger{background-color: #cb2027 !important; }  .btn-danger:hover{background-color: #a81a20 !important ; }
                                                </style>
                                                    <?= $this->Html->link('<i class="fa fa-search fa-lg"></i> Zoom', Router::url($imagen['FotoInmueble']['ruta'],true), array('class'=>'btn btn-primary m-t-5', 'escape'=>false, 'target'=>'blanck')) ?>
                                                   
                                                   <?= $this->Form->postLink(
                                                           '<i class="fa fa-trash fa-lg"></i> Eliminar', 
                                                           array(
                                                               'controller'=>'Inmuebles','action'=>'eliminar_foto',
                                                               $imagen['FotoInmueble']['id'],$imagen['FotoInmueble']['inmueble_id']
                                                            ), 
                                                           array(
                                                               'inline'=>false,
                                            ...
                                            <div class="row m-t-35">
                                                <h5><font color="black">Subir Imágenes</h5>
...
<!--                                                <div class="col-lg-12 m-t-35">
                                                ...
                                                <div class="col-xl-12">
                                                    ...
                                                    <?= $this->Html->link('Regresar al inmueble', 'view/'.$id, array('class'=>'btn btn-primary m-t-15 col-sm-12')) ?>
                                                </div>
                                                </div>
