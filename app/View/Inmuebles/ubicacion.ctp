                                ...
                                <div class="card-block m-t-20">
                                    <div id="rootwizard">
                                        <ul class="nav nav-pills">
                                            ...
                                            <li class="nav-item m-t-15">
                                                <a class="nav-link active" href="#" data-toggle="tab" style="pointer-events: none">
                                                    <span class="userprofile_tab2">3</span>Ubicación de Inmueble</a>
                                            </li>
                                            
                                            <li class="nav-item m-t-15">
                                                <?= $this->Html->link(
                                                        '<span class="userprofile_tab1 tab_clr">4</span>Datos de Propietario</a>',
                                                        array(
                                                            'controller'=>'inmuebles',
                                            ...
                                            <li class="nav-item m-t-15">
                                                <?= $this->Html->link(
                                                        '<span class="userprofile_tab1 tab_clr">5</span>Archivos Multimedia</a>',
                                                        array(
                                                            'controller'=>'inmuebles',
                                                            'action'=>'anexos',
                                                            $inmueble['Inmueble']['id']
                                        ...
                                        <div class="card-block m-t-35">
                                            <h3><font color="black">Dirección</font></h3>
                                            <div class="row">
                                                ...
                                                <?php echo $this->Form->input('numero_exterior', array('name'=>'numero_ext','div' => 'form-group col-md-2','class'=>'form-control','label'=>'Número Exterior'))?>
                                                
                                                <?php echo $this->Form->input('numero_interior', array('div' => 'form-group col-md-2','class'=>'form-control','label'=>'Número Interior'))?>
                                                <?php echo $this->Form->input('colonia', array('name'=>'colonia','div' => 'form-group col-md-4','class'=>'form-control','label'=>'Colonia'))?>
                                                
                                                <?php echo $this->Form->input('delegacion', array('name'=>'delegacion','div' => 'form-group col-md-4','class'=>'form-control','label'=>'Delegación o Municipio'))?>
                                                <?php echo $this->Form->input('ciudad', array('name'=>'ciudad','div' => 'form-group col-md-4','class'=>'form-control','label'=>'Ciudad'))?>
                                                
                                                <?php echo $this->Form->input('cp', array('name'=>'cp','div' => 'form-group col-md-4','class'=>'form-control','label'=>'Código Postal'))?>

                                                <?php echo $this->Form->input('estado_ubicacion', array('name'=>'estado_ubicacion','div' => 'form-group col-md-4','class'=>'form-control','label'=>'Estado', 'type'=>'select', 'options' => $estados))?>
                                                ...
                                                <div class="col-xl-6">
                                                    <input type="submit" value="Guardar Información e ir al siguiente paso" class="btn btn-success" style="width:100%" onclick="javascript:document.getElementById('InmuebleReturn').value=2">
                                                </div>
                                                </div>
                                                <?= $this->Form->end()?>
                                            </div>
...
$(document).ready(function() {
    $('#InmuebleUbicacionForm').bootstrapValidator({
        framework: 'bootstrap',
        fields: {
