...
<div id="content" class="bg-container">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($propiedades as $inmueble):?>
                                    <tr>
                                        ...
                                        <td class="filterDiv <?= strtolower($inmueble['Inmueble']['titulo']) ?>">
                                           <div class="col-lg-12 m-t-10" style="background-color: #2e3c54; color:white; padding: 5px;">
                                               <?php echo $this->Form->input('seleccionar'.$i,array('type'=>'checkbox','class'=>'checkbox','label'=>$inmueble['Inmueble']['titulo']))?>
                                           </div>

                                            <?php 
                                                $imagen = (isset($inmueble['FotoInmueble'][0]) ? $inmueble['FotoInmueble'][0]['ruta'] : "/img/no_photo_inmuebles.png");
                                            ?>
                                            <div class="col-lg-2 m-t-10" style="height:150px;background-image: url('<?= $imagen?>'); background-position:center center; background-repeat:no-repeat; background-size:cover "></div>
                                                 <div class="col-lg-9 m-t-10">
                                                     <div class="col-lg-3" >
                                                         <b><?php echo $inmueble['TipoPropiedad']['tipo_propiedad']?></b><br>
                                                         <b><?php echo "V - $".number_format($inmueble['Inmueble']['precio'],2)?></b><br>
                                                         <b><?php echo "R - $".number_format($inmueble['Inmueble']['precio_2'],2)?></b><br>
                                                     ...
                                                     <div class="col-lg-3" style="text-align: right">
                                                         ...
                                                         <?php
                                                                        switch ($inmueble['Inmueble']['liberada']){
                                                                            ...
                                                                            case 4:
                                                                                echo "<div  class='status' style='text-align: center; background-color: #c1272d'>ESCRITURACION</div>";
                                                                                break;
                                                                            case 5:
    ...
    <?php echo $this->Form->hidden('cliente_id',array('value' => $cliente_id))?>
    <?php echo $this->Form->hidden('status',array('value' => "Abierto"))?>
