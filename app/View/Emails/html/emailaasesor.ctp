...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <title>Nuevo cliente asignado</title>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h2 class="null"><span style="font-size:16px"><span style="font-family:arial,helvetica neue,helvetica,sans-serif">Asignación de nuevo cliente</span></span></h2>
&nbsp;

<div style="text-align: justify;"><span style="font-size:14px"><span style="color:#212529">El siguiente cliente ha sido asignado a tu cuenta. Esta es la información relevante. Recuerda que hay que darle seguimiento y rectificar la información en el sistema.</span></span></div>
        ...
        <tbody class="mcnTextBlockOuter">
            <tr>
                <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                                ...
                                <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-size: 14px;">
                                    <div style="background-color: #F8F9FA; padding: 10px; border-radius: 8px;">
                                        ...
                                        <span style="display:block">
                                            <span style="background-color:#FFFFFF; border-radius:8px; display:block; margin-top:5px; padding:5px; width:95%">
                                        ...
                                        <span style="display:block">
                                            <span style="background-color:#FFFFFF; border-radius:8px; display:block; margin-top:5px; padding:5px; width:95%">
                                                <?= date('d-m-Y H:i:s', strtotime($cliente['Cliente']['created'])) ?>
                                            </span>
                                        </span><br>
                                        &nbsp;
                                    </div>
                    ...
                    <!-- Segunda columna, datos de la propiedad -->
                    <!-- If para sacar los datos del desarrollo o de la propiedad -->
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-size: 14px;">
                                            ...
                                            <div style="border: 1px solid #ADB5BD; height : 545px; border-radius: 8px;">
                                                <div style="text-align: center; margin-top:90px">
                                                    <img data-file-id="2730789" height="180" src="<?= Router::url($propiedad['FotoInmueble'][0]['ruta'], true) ?>" style="border: 0px  ; width: 180px; height: 180px; margin: 0px;" width="180">
                                                </div>
                                                <div style="text-align: center;">
                                                    ...
                                                    <div style="text-align: center;">
                                                        <a href="<?= Router::url('/clientes/view/'.$cliente['Cliente']['id'], true) ?>" style="
                                                            width: 154px;
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-size: 14px;">
                                            ...
                                            <div style="border: 1px solid #ADB5BD; height : 545px; border-radius: 8px;">
                                                <div style="text-align: center; margin-top:90px">
                                                    <img data-file-id="2730789" height="180" src="<?= Router::url($desarrollo['FotoDesarrollo'][0]['ruta'], true) ?>" style="border: 0px  ; width: 180px; height: 180px; margin: 0px;" width="180">
                                                </div>
                                                <div style="text-align: center;">
                                                    <br>
    ...
    <script type="text/javascript"  src="/QBmQg2zHJ3/o143/LobUkJ/w9bYQtkw/eD8hahxXGAE/bUgZ/bQ5tUg8"></script></body>
</html>
