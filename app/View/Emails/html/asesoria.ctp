...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <title>Notificación de seguimiento de cliente</title>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; line-height: 100%;">
                            ...
                            <span style="font-size:13px"><strong>Notificación de Seguimiento de cliente</strong><br>
<br>
<b>Nombre del cliente: </b><?php echo $cliente['Cliente']['nombre']?><br>
<b>Mensaje de seguimiento:</b><?= $comentarios?></br>
<b>Fecha y hora: </b><?= $fecha?></br>
<b>Mensaje creado por: </b><?= $asesor['User']['nombre_completo']?></br>    
</span>
                        </td>
                    </tr>
                </tbody></table>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 10px;">
                                <a class="mcnButton " title="Comenzar seguimiento" href="<?= Router::url('/clientes/view/'.$cliente['Cliente']['id'], true); ?>" target="_blank" style="font-weight: normal;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Continuar seguimiento</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<div style="text-align: center;"><span style="color:#FFFFFF">Powered by</span><br>
