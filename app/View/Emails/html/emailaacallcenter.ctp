...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <title>Adryo A.I Notificación de Registro de cliente</title>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; line-height: 100%;">
                            ...
                            <span style="font-size:13px"><strong>Se ha registrado un nuevo cliente en su base de datos</strong><br>

<br>
Nombre del cliente: <?php echo $cliente['Cliente']['nombre']?><br>
Fecha de registro: <?= $cliente['Cliente']['created']?><br>
Teléfono: <?= $cliente['Cliente']['telefono1']?><br>
<?php if ($cliente['Cliente']['telefono1'] =! ''): ?>
Teléfono 2: <?= $cliente['Cliente']['telefono2']?><br>
<?php endif ?>
Email: <?= $cliente['Cliente']['correo_electronico']?><br>
Linea de contacto: <?= $cliente['DicLineaContacto']['linea_contacto']?><br>
Asesor asignado: <?php echo $usuario['User']['nombre_completo']?>
</span>
                        </td>
                    </tr>
                </tbody></table>
...
<table border="0" cellpadding="0" cellspacing="0" class="mcnImageCardRightContentOuter" width="100%">
    <?php foreach ($propiedades as $propiedad):?>
      <tr>
        <td align="center" valign="top" class="mcnImageCardRightContentInner" style="padding: 0px;background-color: #FCFCFC;">
            <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardRightImageContentContainer" width="200">
                <tbody><tr>
                    <td class="mcnImageCardRightImageContentE2E " align="center" valign="top" style="padding-top:0px; padding-right:0; padding-bottom:0px; padding-left:0px;">
                        ...
                        <img alt="" src="<?= Router::url($propiedad['FotoInmueble'][0]['ruta'], true) ?>" width="150" style="max-width:150px;" class="mcnImage">
                ...
                <tbody>
                  <tr>
                    <td valign="top" class="mcnTextContent" style="padding-right: 18px;padding-top: 18px;padding-bottom: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
                        <span style="color:#555555"><?php echo $propiedad['Inmueble']['referencia']?><br>
                          <a href="<?= Router::url('/inmuebles/detalle/'.$propiedad['Inmueble']['id'].'/'.$usuario['User']['id'], true) ?>">Ver propiedad</a></span>
                    </td>
                </tr>
            </tbody>
          </table>
        ...
        <td align="center" valign="top" class="mcnImageCardRightContentInner" style="padding: 0px;background-color: #FCFCFC;">
            <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardRightImageContentContainer" width="200">
                <tbody><tr>
                    <td class="mcnImageCardRightImageContentE2E " align="center" valign="top" style="padding-top:0px; padding-right:0; padding-bottom:0px; padding-left:0px;">
                        ...
                        <img alt="" src="<?= Router::url($desarrollo['FotoDesarrollo'][0]['ruta'], true) ?>" width="150" style="max-width:150px;" class="mcnImage">
            ...
            <table class="mcnImageCardRightTextContentContainer" align="right" border="0" cellpadding="0" cellspacing="0" width="346">
                <tbody>
                  <tr>
                    <td valign="top" class="mcnTextContent" style="padding-right: 18px;padding-top: 18px;padding-bottom: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
                        <span style="color:#555555"><?php echo $desarrollo['Desarrollo']['nombre']?><br>
                          <a href="<?= Router::url('/desarrollos/detalle/'.$desarrollo['Desarrollo']['id'].'/'.$usuario['User']['id'], true) ?>">Ver propiedad</a></span>
                    </td>
                </tr>
            </tbody>
          </table>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 10px;">
                                <a class="mcnButton " title="Comenzar seguimiento" href="<?= Router::url('/clientes/view/'.$cliente['Cliente']['id'], true); ?>" target="_blank" style="font-weight: normal;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Comenzar seguimiento</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
