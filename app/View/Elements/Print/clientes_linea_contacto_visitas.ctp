<?php
    $total_visitas = 0; $total_inversion = 0; $maximo_registro_visitas = 0;
...
<div class="card">
    <div class="card-header bg-blue-is">
        CONTACTOS POR MEDIO DE PROMOCIÓN VS VISITAS
    ...
    <div class="card-block">
        <div class="row">
            <div class="col-sm-12">
                <div id="grafica_visitas_lineas_contacto" style="width: 80%; min-height:600px;"></div>
            </div>
...
<script>
    ...
    function graficaVisitasLineasContacto(){
      var data = google.visualization.arrayToDataTable([
          ['Linea de contacto', 'Contactos <?= number_format($total_clientes_lineas[0][0]['total_registros']) ?>', {role: 'annotation'}, 'Visitas <?= $total_visitas?>', {role: 'annotation'},'Inversión en Publicidad $ <?= number_format($total_inversion) ?>'],
