...
<div class="card">
    ...
    <div class="card-block" style="width: 100%; height: 280px;">
      <div class="row">
        <div class="col-sm-12">
          <div id="grafica_estatus_general_clientes" style="width:80%"></div>
        </div>
          ...
          <?php
            if( empty( $clientes_anuales ) ) {
              ...
              foreach ( $clientes_anuales as $clientes_anuales_grafica ){
                switch( $clientes_anuales_grafica['clientes']['status'] ) {
                  case 'Activo':
                      $color = "#BF9000";
                      $cliente_estatus = $name_status_cliente[$clientes_anuales_grafica['clientes']['status']];
                  break;
                  case 'Inactivo':
                      $color = "#000000";
                      $cliente_estatus = $name_status_cliente[$clientes_anuales_grafica['clientes']['status']];
                ...
                echo '["'.$cliente_estatus.'", '.$clientes_anuales_grafica['0']['total_clientes'].', "'.$color.'"],';
              }
            }
          ?>
