...
<div class="card">
    ...
    <div class="card-block" style="width: 100%;">
      <div class="row">
        <div class="col-sm-12" >
            <div id="metas_ventas_desarrollo" class="grafica no"></div>
        </div>
        <div class="col-sm-12 m-t-35">
          <small id="ventas_vs_metas_periodo_tiempo"></small>
        </div>
      </div>
    </div>
</div>
...
<script>
    ...
    function graficaVentasMetasDash( rangoFechas, cuentaId, desarrolloId ,asesorId ){ 
          $.ajax({
            type: "POST",
            ...
            success: function ( response ) {
				...
				for (let i in response){
					...
					ventasmes  += parseInt( response[i].ventas_q);
					objetivo   += parseInt( response[i].objetivo_q);
            	}
				if(objetivo==0){
					cumplido=0
				}else{
				...
				document.getElementById("ventas_vs_metas_periodo_tiempo").innerHTML =rangoFechas;
                drawVentasMetasDash(response,ventasmes,objetivo,cumplido);
    ...
    function drawVentasMetasDash(response,ventasmes,objetivo,cumplido){
        ...
        am5.ready(function () {
			var root = am5.Root.new("metas_ventas_desarrollo");
			root.setThemes([
