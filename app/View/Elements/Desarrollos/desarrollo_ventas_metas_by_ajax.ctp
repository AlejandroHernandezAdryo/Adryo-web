...
<div class="card">
    ...
    <div class="card-block" style="width: 100%;">
      <div class="row">
        <div class="col-sm-12" >
            <div id="metas_ventas_desarrollo" class="grafica"></div>
        </div>
...
<script>
    ...
    function graficaVentasMetasDesarrollo( rangoFechas, cuentaId, desarrolloId ,asesorId ){ 
          $.ajax({
            type: "POST",
            ...
            success: function ( response ) {
                ...
                drawVentasMetas(response,ventasmes,objetivo,cumplido);
            },
            error: function ( err ){
    ...
    function drawVentasMetas(response,ventasmes,objetivo,cumplido){
