    ...
    var data = google.visualization.arrayToDataTable([
        ...
        <?php else: ?>
            ...
            <?php foreach ($kpi_arreglo_anual as $periodo):?>
                ['<?= $periodo['periodo']?>', <?= $periodo['objetivo_q']?>, <?= $periodo['objetivo_q'] ?>, <?= $periodo['ventas_q']?>,<?= $periodo['ventas_q']?>, <?php $porciento_grafica = ($periodo['ventas_q']/$periodo['objetivo_q'])*100; echo $porciento_grafica;  ?> ],
                <?php
