<div class="card">
    <div class="card-header bg-blue-is">
		INDICADORES DE DESEMPEÑO HISTÓRICOS ACUMULADOS AL (<small id="card_historico_periodo_tiempo"></small>)
    </div>
						...
						<a href="#">
							<div class="widget_icon_bgclr icon_align bg-white section_border mt-1">
								...
								<div class="text-xs-right text-black">
									<h3 class="kpi"></h3>
									<p>Leads: <span id="leadsHistorico"></span></p>
								</div>
							</div>
						</a>
					</div>
						...
						<a href="#">
							<div class="widget_icon_bgclr icon_align bg-white section_border bg-emails mt-1">
								...
								<div class="text-xs-right text-black">
									...
									<p>Correos: <span id="emailsHistorico"></span></p>
								</div>
							</div>
						</a>
