<style>
    #grafica_activos_linea_contacto{
        width: 100%;
        height: 500px;
    }
...
<div class="card">
    ...
    <div class="card-block" style="width: 100%;">
      <div class="row">
        <div class="col-sm-12" >
          <div id="grafica_activos_linea_contacto" class="grafica"></div>
        </div>
        <div class="col-sm-12 m-t-35">
          <small id="leads_activos_linea_contacto_periodo_tiempo"></small>
        </div>
      </div>
    </div>
</div>
...
<script>
  // Se mandan a llamar los datos para la grafica
    function graficaActivosLineaContacto( rangoFechas, cuentaId, desarrolloId ,asesorId ){
        $.ajax({
        type: "POST",
        url: '<?php echo Router::url(array("controller" => "leads", "action" => "grafica_activos_linea_contacto")); ?>',
        cache: false,
        ...
        success: function ( response ) {
            ...
            document.getElementById("leads_activos_linea_contacto_periodo_tiempo").innerHTML =rangoFechas;
            if (maximoLead==0) {
                maximoLead=10
            }
            ...
            drawActivosLineaContacto( response,maximaInversion,InversionTotal,cantidadTotal, maximoLead );
    ...
    function drawActivosLineaContacto(response,maximaInversion,InversionTotal,cantidadTotal, maximoLead){
		am5.ready(function () {
			var root = am5.Root.new("grafica_activos_linea_contacto");
			root.setThemes([
			...
			var series = chart.series.push(am5xy.ColumnSeries.new(root, {
				name                  : `Clientes Activos: ${cantidadTotal}`,
				xAxis                 : xAxis,
				yAxis                 : yAxis,
				valueYField           : "leads",
