...
<div class="card">
    ...
    <div class="card-block" style="width: 100%;">
      <div class="row">
        <div class="col-sm-12" >
          <div id="grafica_ventas_linea_contacto_g" class="grafica"></div>
        </div>
...
<script>
  ...
  function graficaVentasLineaContactoViewDesarrollo( rangoFechas, cuentaId, desarrolloId ,asesorId ){
    
    $.ajax({
        type: "POST",
        url: '<?php echo Router::url(array("controller" => "leads", "action" => "leads_ventas_inversion_vista_desarrollo")); ?>',
        cache: false,
