...
<script>
  ...
  // Se mandan a llamar los datos para la grafica
    function graficaVisitasLineaContactoVistaDesarrollo( rangoFechas, cuentaId, desarrolloId ,asesorId ){
    
        $.ajax({
            type: "POST",
            url: '<?php echo Router::url(array("controller" => "leads", "action" => "leads_visitas_inversion_vista_desarrollo")); ?>',
            cache: false,
