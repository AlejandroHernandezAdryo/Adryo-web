...
<div class="card">
    ...
    <div class="card-block">
        <div class="row">
            <div class="col-sm-12">
                <div id="grafica_clientes_lineas_contacto" style="width: 100%; min-height:600px;"></div>
            </div>
...
<script>
  ...
  var data = google.visualization.arrayToDataTable([
      ['Linea de contacto', 'Leads <?= number_format($contactos) ?>', {role: 'annotation'}, 'Ventas <?= $total_ventas?>', {role: 'annotation'},'Inversión en Publicidad $ <?= number_format($total_inversion) ?>'],
