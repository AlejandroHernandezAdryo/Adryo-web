...
<div class="card">
    <div class="card-header bg-blue-is cursor"  data-toggle='modal'>
      CLIENTES Y VISITAS POR LINEA DE CONTACTO
    </div>

    <div class="card-block" style="width: 100%;">
      <div class="row">
        <div class="col-sm-12" >
          <div id="grafica_visitas_linea_contacto" class="grafica no"></div>
        </div>
...
<script>
  ...
  function graficaClientesVisitasDash( rangoFechas, cuentaId, desarrolloId ,asesorId ){
    
    $.ajax({
        type: "POST",
        url: '<?php echo Router::url(array("controller" => "clientes", "action" => "clientes_visitas_linea_dash")); ?>',
        cache: false,
        ...
        success: function ( response ) {
        	...
        	drawgraficaClientesVisitasDash( response,maximaInversion,InversionTotal,cantidadTotal,visitasTotal, maximoLead );
  ...
  // Es el metodo de la grafica. 1: {medio: 'Flyer', leads: '3', inversion: 0, visitas: 0}
  function drawgraficaClientesVisitasDash(response,maximaInversion,InversionTotal,cantidadTotal,visitasTotal, maximoLead){
		am5.ready(function () {
