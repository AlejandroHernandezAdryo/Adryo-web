<style>
		#cliente_motivo_inactivacion_temporal{
  		width: 100%;
  		height: 500px;
		}
</style>
...
<div class="card">
    ...
    <!-- <i class='fa fa-exclamation-triangle fa-x2'></i> -->
        <span style="float:right">
            Total: <span id="totalclientesInectivosTemporales"></span>
        </span>
    </div>
    ...
    <div class="card-block" style="width: 100%;">
      <div class="row">
        <div class="col-sm-12" >
          <div id="cliente_motivo_inactivacion_temporal"></div>
          
        </div>
        <div class="col-sm-12 m-t-35">
          <small id="cliente_inectivos_temporales_periodo_tiempo"></small>
        </div>
      </div>
    </div>
</div>
...
<script>
   ...
   function graficaMotivoInactivoTempo( rangoFechas, cuentaId, desarrolloId ,asesorId ){
    $.ajax({
        type: "POST",
        url: '<?php echo Router::url(array("controller" => "clientes", "action" => "grafica_motivo_inactivo_temporal")); ?>',
        cache: false,
        ...
        success: function ( response ) {
          var Total    = 0;
        	...
        	document.getElementById("totalclientesInectivosTemporales").innerHTML =Total;
        	document.getElementById("cliente_inectivos_temporales_periodo_tiempo").innerHTML =rangoFechas;
          drawClienteMotiviTemporal( response );
   ...
   function drawClienteMotiviTemporal( response ) {
    am5.ready(function () {
			var root = am5.Root.new("cliente_motivo_inactivacion_temporal");
			root.setThemes([
