...
<div class="card">
    <div class="card-header bg-blue-is">
        ESTAPAS DE CLIENTES ACTIVOS AL (FECHA DEL ULTIMO DÍA DEL PERIODO SOLICITADO)
        <span style="float:right">
            Total: <span id="sumatorioClientesTemperatura"></span>
        </span>
    </div>

    <div class="card-block" style="width: 100%; height: 370px">
        <div class="row">
            <div class="col-sm-12">
                <div id="grafica_temperatura_clientes"></div>
            </div>
  ...
  var data = google.visualization.arrayToDataTable([
    ...
    <?php
        ...
        foreach( $temperatura_clientes as $temperaturas ){
            switch( $temperaturas['Cliente']['etapa'] ) {
                case 1:
