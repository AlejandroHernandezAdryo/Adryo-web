        ...
        <nav class="navbar navbar-static-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="https://inmosystem.com.mx" target="_blank">
                    <?= $this->Html->image('logo_inmosystem.png',array('class'=>'admin_img','alt'=>'Logo Inmosystem', 'style'=>'max-height: 46px !important;'))?>
                </a>
                <div class="menu">
        ...
        <div id="left">
            ...
            <div class="menu_scroll">
                ...
                <ul id="menu" style="font-size: 1.03rem !important;">
                    ...
                    <li class="treeview no-print">
                        <a href="#"><i class="fa fa-bar-chart-o"></i><span>Reportes avanzados</span><i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li class="treeview">
                                <?php echo $this->Html->link('<i class="fa fa-globe"></i><span> Reportes Gerenciales</span>',array('controller'=>'users','action'=>'reportes_gerenciales'),array('escape'=>false))?>
                                <!-- <a href="#">
                                 <i class="fa fa-chevron-circle-right"></i><span> Reportes Gerenciales</span>
                                </a> -->
                            </li>
                            <li class="treeview">
                                <?php echo $this->Html->link('<i class="fa fa-user"></i><span> Reportes Por Asesor</span>',array('controller'=>'users','action'=>'reportes_asesor'),array('escape'=>false))?>
                            </li>
                        </ul>
                    </li>
                    <li>
...
<!--                            <i class="fa fa-user"></i><span>Clientes</span>-->
                    ...
                    <?php }?>
                    <li class="treeview no-print">
                        <a href="#"><i class="fa  fa-briefcase"></i><span>Proveedores</span><i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                          ...
                          <!-- <li><?php echo $this->Html->link('<i class="fa fa-user-plus"></i> Agregar proveedor',array('controller'=>'proveedors','action'=>'add'),array('escape'=>false))?></li> -->
                        </ul>
                    </li>
                    <li class="treeview no-print">
                        <a href="#"><i class="fa fa-exchange"></i><span>Banco / Efectivo</span><i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li>
                                <?php echo $this->Html->link('<i class="fa fa-bars"></i> Cuentas bancarias',array('controller'=>'bancos','action'=>'index'),array('escape'=>false))?>
                            </li>
                            <li>
                                <?php echo $this->Html->link('<i class="fa fa-bars"></i> Transferencias bancarias',array('controller'=>'transaccions','action'=>'transferencia'),array('escape'=>false))?>
                            </li>
                        </ul>
                    </li>
                    ...
                    <?php endif ?>
                    <li class="treeview no-print">
                        <a href="#"><i class="fa fa-money"></i><span>Ingreso / Gasto</span><i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li class="treeview">
                                <a href="#">
                                 <i class="fa fa-chevron-circle-right"></i><span> Gastos</span>
                                </a>
                                <ul class="treeview-menu">
                                    <li><?php echo $this->Html->link('<i class="fa fa-plus"></i><span> Nuevo gasto</span>',array('controller'=>'facturas','action'=>'add'),array('escape'=>false))?></li>
                                    <li><?php echo $this->Html->link('<i class="fa fa-bars"></i><span> Listado gastos</span>',array('controller'=>'facturas','action'=>'index'),array('escape'=>false))?></li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="treeview-menu">
                            <li class="treeview">
                                <a href="#">
                                 <i class="fa fa-chevron-circle-left"></i><span> Ingresos</span>
                                </a>
                                <ul class="treeview-menu">
                                    <li><?php echo $this->Html->link('<i class="fa fa-bars"></i><span> Listado de ingresos</span>',array('controller'=>'aportacions','action'=>'index'),array('escape'=>false))?></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
