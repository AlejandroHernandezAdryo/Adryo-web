            ...
            <div class="modal-body">
                <div class="row mt-1">
                    <div class="col-sm-12">
                        ...
                        <input id="input-fa" name="data[Factura][archivos][]" type="file" class="file-loading" accept=".pdf, .jpg, .png, .xml" multiple required>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-block">
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="<?= (empty($factura['Desarrollo']['id']) ? 'col-sm-12 push-lg-4 col-lg-4' : 'col-sm-12 col-lg-4') ?>">
                                    ...
                                    <b>Fecha de Pago: </b><?= $factura['Factura']['fecha_pago']=="0000-00-00"?"Sin Fecha de Pago":date_format(date_create($factura['Factura']['fecha_pago']),"d-M-Y")?><br>
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                if ($validacion['validated'] == "" && $validacion['estado']==2 || $factura['Factura']['estado']==2){
                                                    $pagar = 0;
                                                }
                                            ?>
                                                <tr>
...
$(document).ready(function () {
    ...
    $("#input-fa").fileinput({
        theme: "fa",
        //allowedFileExtensions: ["jpg", "png","jpeg","pdf","xml"],
        showRemove : false,
        showUpload : false,
        resizeImage: true,
        maxImageWidth: 800,
