<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Lista de clientes no atendidos</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Lista de clientes no atendidos</h3>
                  <?= $this->Form->create('Cliente',array('url'=>array('action'=>'no_atendidos')))?>
            <div class="input-group">
              <?= $this->Form->input('campo',array('class'=>'form-control','placeholder'=>'Buscar por nombre, apellidos o correo electrónico','label'=>false))?>
              <?php
                if ($this->Session->read('Auth.User.Group.call')==1){
              ?>
              <?= $this->Form->input('user',array('class'=>'form-control','type'=>'select','empty'=>'Todos los agentes','label'=>false))?>
                <?php }?>
