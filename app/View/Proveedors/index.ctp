...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true" >
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <?= $this->Form->create('Proveedor',array('url'=>array('action'=>'add')))?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        <div class="modal-body">
            ...
            <!-- Form delete cliente -->
            <?php
                echo $this->Form->create('ProveedorDelete', array('url'=>array('controller'=>'Proveedors', 'action'=>'delete')));
                        ...
                        <div class="card-block m-t-35">
                            <div class="card-block p-t-25">
                                <table class="table table-striped table-bordered table-hover" id="sample_1" class="m-t-35">
                                    ...
                                    <tr>
                                        <td ><?= $this->Html->link($proveedor['Proveedor']['razon_social'],array('action'=>'edit', $proveedor['Proveedor']['id']))?></td>
                                        <td ><?= $this->Html->link($proveedor['Proveedor']['nombre_comercial'], array('action'=>'edit', $proveedor['Proveedor']['id']))?></td>
                                        <td style="text-transform:uppercase"><?= $proveedor['Proveedor']['rfc']?></td>
                                        <td ><?= $proveedor['Proveedor']['direccion']?></td>
                                        <td ><?= $proveedor['Proveedor']['telefono_1']?></td>
                                        <td ><?= $proveedor['Proveedor']['telefono_2']?></td>
                                        <td ><?= $proveedor['Proveedor']['email']?></td>
                                        <td>
                                            <a class='pointer' onclick="myFunction(<?= $proveedor['Proveedor']['id'] ?>);">
