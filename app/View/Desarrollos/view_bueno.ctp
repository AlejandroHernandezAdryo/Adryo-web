...
<!-- Modal nueva factura -->
<div class="modal fade" id="modal_nueva_factura" tabindex="-1" role="dialog" aria-hidden="true" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= $this->Form->hidden('ruta', array('value'=>3)) ?>
                <?= $this->Form->hidden('total') ?>
                <?= $this->Form->hidden('desarrollo_id', array('value'=>$desarrollo['Desarrollo']['id'])) ?>
                    <div class="row mt-1">
                        <?= $this->Form->input('proveedor_id', array('class'=>'form-control', 'div'=>'col-sm-12 col-lg-6', 'type'=>'select', 'empty'=>'Seleccione una opción', 'options'=>$proveedores, 'label'=>'Proveedor')) ?>
                        <?= $this->Form->input('categoria_id', array('class'=>'form-control', 'div'=>'col-sm-12 col-lg-6', 'type'=>'select', 'empty'=>'Seleccione una opción', 'options'=>$categorias, 'label'=>'Categoria de Factura')) ?>
                    </div>
                    <div class="row mt-1">
                    ...
                    <div class="row mt-1">
                        <div class="col-sm-12">
                            <label for="documento de pago">Documento(s) de factura</label>
                            <input id="input-fa" name="data[Factura][archivos][]" type="file" class="file-loading" accept=".pdf, .jpg, .png" multiple>
                        </div>
                    </div>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-blue-is">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <button class="btn btn-success float-right btn-labeled" data-toggle="modal" data-target="#modal_nueva_factura">
                                Agregar nueva factura
                            </button>
                        </div>
                    </div>
