                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                        ...
                                        <div class="card-block m-t-35">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php
                                                    ...
                                                    echo $this->Form->input('titulo', array('class'=>'form-control','div' => 'form-group col-md-6'));
                                                ...
                                                <?php
                                                    ...
                                                    $estado = array('Excelente'=>'Excelente','Bueno'=>'Bueno','Regular'=>'Regular','Malo'=>'Malo','Remodelado'=>'Remodelado','Para Remodelar'=>'Para Remodelar');
                                ...
                                <div class="card-block" style="margin-left: 15px; margin-right: 15px">
                                            ...
                                            <div class="row">
                                                <?php echo $this->Form->input('construccion', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Superficie habitable (m2)'))?>
                                                <?php echo $this->Form->input('construccion_no_habitable', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Superficie No Habitable (m2)'))?>
                                                ...
                                                <?php echo $this->Form->input('recamaras', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Recamaras (cuantas)'))?>
                                                <?php echo $this->Form->input('banos', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Baños'))?>
                                                <?php echo $this->Form->input('medios_banos', array('div' => 'form-group col-md-4','class'=>'form-control','label'=>'Medios Baños'))?>
                                        ...
                                        <div class="card-block" style="margin-left: 15px; margin-right: 15px">
                                                    ...
                                                    <div class="checkbox radio_Checkbox_size4 col-lg-3">
                                                        <label>
                                                            <?= $this->Form->input('closets_blancos', array('type'=>'checkbox','label'=>false,'div'=>false,'default'=>'unchecked'));?>
                                                            <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                            Closets Blancos
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="checkbox radio_Checkbox_size4 col-lg-3">
                                                        <label>
                                                            <?= $this->Form->input('gimansio', array('type'=>'checkbox','label'=>false,'div'=>false,'default'=>'unchecked'));?>
                                                            <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                            Gimnasio
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="card-block" style="margin-left: 15px; margin-right: 15px">
                                            <h2><font color="black">Replicar tipo</font></h2>
                                            ...
                                            <div class="row">
                                                <?php echo $this->Form->input('cantidad', array('div' => 'form-group col-md-2','class'=>'form-control','label'=>'Cantidad a Replicar'))?>
                                            </div>
                                        </div>
                                        <div class="card-block" style="margin-left: 15px; margin-right: 15px">        
