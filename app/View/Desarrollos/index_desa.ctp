        ...
        <div class="inner bg-light lter bg-container">
            <div class="card mt-1">
                <div class="card-block">
                    <!-- Contadores generales **Korner 11-05-2023** -->
                    <div class="row mt-1">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card mt-1">
                                <div class="card-header">
                                    <div class="col-sm-10" style="cursor: pointer;" onclick="location.href='<?php echo Router::url('/',true)."Desarrollos/view/".$desarrollo['Desarrollo']['id'] ?>';">
                                        <?php 
                                            echo $this->Html->link($desarrollo['Desarrollo']['nombre'],array('action'=>'view',$desarrollo['Desarrollo']['id']));
                                        ?>
                                    </div>
                                </div>
                                <div class="card-block">
                                    ...
                                    ?>
                                    <div class="col-lg-2" style="border-radius:8px;height:230px;background-image: url('<?= Router::url('/',true).$image; ?>'); background-position:center center; background-repeat:no-repeat; background-size:cover; cursor: pointer;" onclick="location.href='<?php echo Router::url('/',true)."desarrollos/view/".$desarrollo['Desarrollo']['id']; ?>';">
                                    </div>
                                    <div class="col-lg-5 col-sm-12">
                                        <div class="col-lg-6">
                                            <b>Tipo de Desarrollo:</b><br><?php echo $desarrollo['Desarrollo']['tipo_desarrollo']?><br>
                                            <b>Torres: </b><br><?php echo $desarrollo['Desarrollo']['torres']?><br>
                                            <b>Unidades Totales: </b><br><?php echo $desarrollo['Desarrollo']['unidades_totales']?><br>
                                            <b>Entrega: </b><br><?php echo ($desarrollo['Desarrollo']['entrega']=="Inmediata" ? $desarrollo['Desarrollo']['entrega'] : date('d/M/Y',  strtotime($desarrollo['Desarrollo']['fecha_entrega'])))?><br>
                                            <b>Colonia: </b><br><?= $desarrollo['Desarrollo']['colonia']?><br>
                                        </div>
                                        <div class="col-lg-3 mt-2" style="text-align:center;">
                                            <div class="row">
                                                <div style="display:flex;justify-content:space-evenly;">
                                                    <div>
                                                        <p><?= $this->Html->image('m2.png',array('width'=>'25%'))?></p>
                                                    ...
                                                    <div>
                                                        <p><?= $this->Html->image('recamaras.png',array('width'=>'25%'))?></p>
                                            ...
                                            <div class="row">
                                                <div style="display:flex;justify-content:space-evenly;">
                                                    <div>
                                                        <p><?= $this->Html->image('banios.png',array('width'=>'25%'))?></p>
                                                    ...
                                                    <div>
                                                        <p><?= $this->Html->image('autos.png',array('width'=>'25%'))?></p>
