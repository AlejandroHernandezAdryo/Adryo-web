            ...
            <div class="card ">
                        <div class="card-block">
                            <div class="card-block p-t-25" style="color:black">
                                ...
                                Nombre de desarrollo: <b><?= $this->Html->link($desarrollo['Desarrollo']['nombre'],array('controller'=>'desarrollos','action'=>'view',$desarrollo['Desarrollo']['id']))?></b>
                                                                </font>
                            ...
                            <div class="card-block p-t-25">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1" class="m-t-35">
                                    ...
                                    <tr>
                                        <td><?= $visita['Desarrollo']['nombre']?></td>
                                        <td><?= date("d/M/Y H:i", strtotime($visita['Event']['fecha_inicio']))?></td>
                                        <td>Cita en Desarrollo</td>
                                        <td><?= $visita['Event']['nombre_evento']?></td>
                                        <td><?= $visita['User']['nombre_completo']?></td>
