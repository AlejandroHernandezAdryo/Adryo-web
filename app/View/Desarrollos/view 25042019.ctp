                                                    ...
                                                    <td>
                                                        <small>
                                                            <?php
                                                                ...
                                                                case 0: //No liberada
                                                                    echo "<span class='chip' style='text-align: center; background-color: #fcee21; color:#000;'>BLOQUEADO</span>";
                                                                    break;

                                                                case 1: // Libre
                                                                    echo "<span class='chip' style='text-align: center; background-color: #39b54a; color:white;'>LIBRE</span>";
                                                                    break;

                                                                case 2:
                                                                    echo "<span class='chip' style='text-align: center; background-color: #fbb03b'>RESERVA</span>";
                                                                    break;

                                                                case 3:
                                                                    echo "<span class='chip' style='text-align: center; background-color: #29abe2; color: white;'>CONTRATO</span>";
                                                                    break;

                                                                case 4:
                                                                    echo "<span class='chip' style='text-align: center; background-color: #c1272d; color: white;'>ESCRITURACION</span>";
                                                                    break;
                                                                case 5:
                                                                    echo "<span class='chip' style='text-align: center; background-color: red'>BAJA</span>";
                                                                    break;
                                                                } 
                                                            ?>
