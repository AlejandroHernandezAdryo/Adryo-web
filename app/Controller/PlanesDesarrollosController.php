 ...
 */
    ...
    public function beforeFilter() {
        ...
        $this->Auth->allow(array('esquema_pago'));
    ...
    */
    ...
    /* -------------------------- Api Esquemas de pago --------------------------
    *
    * 06/01/2023 - EMC
    * Api para consultar los esquemas de pago de desarrollo
    * usando como parametro principal desarrollo_id y secundario inmueble_id
    *
    */
    public function esquema_pago() {
        ...
        if( $this->request->is('post') ){
            ...
            if(!empty( $this->request->data['inmueble_id'] ) ) {
                ...
                $desarrollo_id = $desarrollo[0]['DesarrolloInmueble']['desarrollo_id'];
            }
