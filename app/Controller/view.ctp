    ...
    <div class="outer">
        ...
        <div class="inner bg-container">
            ...
            <?php if ( $this->Session->read('Permisos.Group.id') != 3 ): ?>
                ...
                <!-- Grafica de META VS. VENTAS (ÚLTIMO AÑO) -->
                <div class="row mt-1">
                    <div class="col-sm-12">
                ...
                <!-- Grafica de CLIENTES POR FORMA DE CONTACTO DE OCTOBER -->
                <div class="row mt-1">
                    <div class="col-sm-12">
                ...
                <!-- Grafica de CONTACTOS POR MEDIO DE PROMOCIÓN VS VENTAS -->
                <div class="row mt-1">
                    <div class="col-sm-12">
                ...
                <!-- Grafica de CONTACTOS POR MEDIO DE PROMOCIÓN VS VISITAS -->
                <div class="row mt-1">
                    <div class="col-sm-12">
                                        ...
                                        <table class="table table-sm" id="dataTableInversion">
                                            ...
                                            <tbody>
                                                <?php foreach ($desarrollo['Publicidad'] as $publicidad): ?>
                                                    <tr>
                                                        <td data-search="<?= date("Y-m",strtotime($publicidad['fecha_inicio'])) ?>" ><?= date("Y-m",strtotime($publicidad['fecha_inicio'])) ?></td>
