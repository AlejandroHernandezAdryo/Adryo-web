 ...
 */
    ...
    public $uses = array(
        ...
        public function beforeFilter() {
            ...
            $this->Auth->allow(array('get_clientes', 'get_clientes_detalle', 'get_log_cliente', 'get_lead_cliente_desarrollo', 'get_lead_cliente_inmueble','get_agenda_cliente', 'clientes_params', 'get_cliente_update', 'get_llamdas_cliente', 'get_add_cliente', 'get_options_props', 'get_status_update', 'get_cambio_temp','add_cliente'));
        }
/**
 * index method
 *
        ...
        public function index($tipo = null) {
            ...
            if ($this->request->is('post')) {
                ...
                $like_conditions = array(
                    'Cliente.nombre LIKE "%'.$nombre_cliente.'%"',
                    'Cliente.correo_electronico LIKE "%'.$correo_electronico.'%"',
                    'Cliente.telefono1 LIKE "%'.$telefono.'%"',
                    'Cliente.telefono2 LIKE "%'.$telefono.'%"',
                );
                ...
                $temperatura    = $this->request->data['Cliente']['temperatura'];
                ...
                $cond_temp = "";
                if ($temperatura != "" || !empty($temperatura)){
                    $cond_temp = array('Cliente.temperatura'=>$temperatura);
                }
                
                $cond_etapa = "";
                if ($etapa != "" || !empty($etapa)){
                    $cond_etapa = array('Cliente.dic_etapa_id'=>$etapa);
                }
                ...
                $condiciones = array($cuenta,$all_clientes,$cond_rangos,$like_conditions,$cond_tipo_cliente,$cond_status,$cond_temp,$cond_etapa,$cond_forma_contacto,$cond_asesor, $cond_desarrollo_id, $cond_inmueble_id, $cond_atencion);
                ...
                if (!empty($this->Session->read('Desarrollador'))){
                    ...
                    $clientes = $this->Cliente->find('all',
                        array(
                            'conditions' => array(
                                'AND'=>array(
                                    'Cliente.status'        => array('Activo', 'Inactivo temporal', 'Inactivo'),
                                    'Cliente.user_id <>'    => ''
                                    ),
                                'OR'=>array(
                                    'Cliente.cuenta_id'     => $this->Session->read('CuentaUsuario.CuentasUser.cuenta_id'),
    ...
    public function add() {
        ...
        if ($this->request->is('post')) {
          ...
          $params_cliente = array(
            ...
            'etapa_cliente'       => $this->request->data['Cliente']['dic_etapa_id'],
 ...
 */
    public function edit($id = null) {
        ...
        if ($this->request->is(array('post', 'put'))) {
            ...
            if ($this->request->data['telefono_1'] != '') {
                $telefono = $this->request->data['telefono_1'];
            }
            if ($this->request->data['Cliente']['correo_electronico'] != '') {
                $correo = trim($this->request->data['Cliente']['correo_electronico']);
            }
...
//                                    $this->Email->cc(array('guemes@bosinmobiliaria.com.mx'=>'guemes@bosinmobiliaria.com.mx',
//                                                           //'dir.ventas@bosinmobiliaria.com.mx'=>'dir.ventas@bosinmobiliaria.com.mx',
//                                                           //'admon@bosinmobiliaria.com.mx'=>'admon@bosinmobiliaria.com.mx',
//                                                           //'rodrigo.admon@bosinmobiliaria.com.mx'=>'rodrigo.admon@bosinmobiliaria.com.mx',
//                                                           'luis-basurto@bosinmobiliaria.com.mx'=>'luis-basurto@bosinmobiliaria.com.mx',
//                                                           'citurbe@bosinmobiliaria.com.mx'=>'citurbe@bosinmobiliaria.com.mx',
//                                                           'ventas.df@bosinmobiliaria.com.mx'=>'ventas.df@bosinmobiliaria.com.mx', 
//                                                           //'rsotres@bosinmobiliaria.com.mx'=>'rsotres@bosinmobiliaria.com.mx'
//                                                           )
//                                                    );
                        ...
                        if ($this->request->data['Cliente']['status']=='Inactividad Temporal'){
                            $this->request->data['Event']['cliente_id']     = $this->request->data['Cliente']['id'] ;
                            $this->request->data['Event']['user_id']        = $this->Session->read('Auth.User.id') ;
                            $this->request->data['Event']['nombre_evento']  = "Cliente pide que se le recontacte a partir de este día";
                            $this->request->data['Event']['fecha_inicio']   = $this->request->data['Cliente']['activacion'] ;
                            $this->request->data['Event']['fecha_fin']      = $this->request->data['Cliente']['activacion'] ;
                            $this->request->data['Event']['to']             = $this->Session->read('Auth.User.id') ;
                            $this->request->data['Event']['recordatorio_1'] = $this->request->data['Cliente']['activacion'] ;
                            $this->Event->create();
                            $this->Event->save($this->request->data);
                            $this->request->data['Cliente']['last_edit'] = $this->request->data['Cliente']['activacion'];
                        }
                        
                        if (!empty($this->request->data['Cliente']['mensaje'])){
                            $this->request->data['Agenda']['cliente_id'] = $this->request->data['Cliente']['id'] ;
                            $this->request->data['Agenda']['user_id'] = $this->Session->read('Auth.User.id') ;
                            $this->request->data['Agenda']['fecha'] = date('Y-m-d H:i:s');
                            $this->request->data['Agenda']['mensaje'] = "Cambio de estatus de cliente a: ".$this->request->data['Cliente']['status'].". Causa: ".$this->request->data['Cliente']['mensaje'] ;
                            $this->Agenda->create();
                            $this->Agenda->save($this->request->data);
                        ...
                        // $this->request->data['Cliente']['telefono1']          = $this->request->data['telefono_1'];
                        $this->request->data['Cliente']['correo_electronico']    = $correo;
                        $this->request->data['Cliente']['telefono1']             = $telefono;

                        $this->request->data['Cliente']['dic_tipo_cliente_id']   = $this->request->data['tipo_cliente'];
                        $this->request->data['Cliente']['dic_etapa_id']          = $this->request->data['etapa_cliente'];
                        $this->request->data['Cliente']['dic_linea_contacto_id'] = $this->request->data['forma_contacto'];
                        
            if ($this->Cliente->save($this->request->data)) {
                $this->Session->write('clundef',$this->Cliente->find('count',array('conditions'=>'Cliente.user_id = ""')));
                // $this->Session->setFlash(__('Los cambios del cliente se han guardado exitosamente.'),'default',array('class'=>'mensaje_exito'));
                $this->Session->setFlash('', 'default', array(), 'success'); // Autorizacion para mensaje
                $this->Session->setFlash('Los cambios del cliente se han guardado exitosamente.', 'default', array(), 'm_success'); // Mensaje
 ...
 */
    ...
    **********************************************************/
    ...
    public function pipeline(){
      ...
      $this->set('clientes_e1',$this->Cliente->find('all',array('conditions' => $conditions_e1,'contain'=>$contain_cliente,'order'=>'Cliente.id DESC','fields' => $fields_clientes,)));
      $this->set('clientes_e2',$this->Cliente->find('all',array('conditions' => $conditions_e2,'contain'=>$contain_cliente,'order'=>'Cliente.id DESC','fields' => $fields_clientes,)));
      $this->set('clientes_e3',$this->Cliente->find('all',array('conditions' => $conditions_e3,'contain'=>$contain_cliente,'order'=>'Cliente.id DESC','fields' => $fields_clientes,)));
      $this->set('clientes_e4',$this->Cliente->find('all',array('conditions' => $conditions_e4,'contain'=>$contain_cliente,'order'=>'Cliente.id DESC','fields' => $fields_clientes,)));
      $this->set('clientes_e5',$this->Cliente->find('all',array('conditions' => $conditions_e5,'contain'=>$contain_cliente,'order'=>'Cliente.id DESC','fields' => $fields_clientes,)));
      $this->set('clientes_e6',$this->Cliente->find('all',array('conditions' => $conditions_e6,'contain'=>$contain_cliente,'order'=>'Cliente.id DESC','fields' => $fields_clientes,)));
      $this->set('clientes_e7',$this->Cliente->find('all',array('conditions' => $conditions_e7,'contain'=>$contain_cliente,'order'=>'Cliente.id DESC','fields' => $fields_clientes,)));
    }
    ...
    public function cambiarEstadoPipeline(){
      if ($this->request->is('post')){
        ...
        $this->Agenda->query("UPDATE clientes SET etapa = ".$this->request->data['Cliente']['nuevo_status'].",last_edit = '$timestamp' WHERE id = ".$this->request->data['Cliente']['id']);
        $this->Session->setFlash('', 'default', array(), 'success');
        $this->Session->setFlash('Se ha actualizado el estatus del cliente satisfactoriamente.', 'default', array(), 'm_success'); // Mensaje
    ...
    public function get_clientes_detalle( $cliente_id = null ){
      ...
      switch($db_cliente['Cliente']['temperatura']){
          case 1:
              $db_temp = "Frio";
            break;
          case 2:
      ...
      'user_id'                  => $db_cliente['Cliente']['user_id'],
			...
			'temperatura'              => $db_temp,
			'id_temperatura'           => $db_cliente['Cliente']['temperatura'],
          ...
          if ( $paramconfig['Paramconfig']['ma'] ==1 ){
            if ( !empty($params_cliente['asesor_id']) && $params_cliente['asesor_id'] != $params_user['user_id'] ){
                ...
                if ( $paramconfig['Paramconfig']['asignacion_c_a'] != "" ){
                  ...
                  $this->Email->cc( $arreglo_emails_c_a );
                }
